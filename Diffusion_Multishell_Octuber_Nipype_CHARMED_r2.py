...
templates = {
 ...
 'DWI_eddy_corrected'  : '/media/amr/Amr_4TB/Work/October_Acquistion/Diffusion_Multishell_Kurtosis_workingdir/Multishell_workflow_Kurtosis/_subject_id_{subject_id}/eddy/eddy_corrected.nii.gz',
 'To_Wax_Transformations'  : '/media/amr/Amr_4TB/Work/October_Acquistion/Diffusion_Multishell_Kurtosis_workingdir/Multishell_workflow_Kurtosis/_subject_id_{subject_id}/FA_To_WAX_Template/transformComposite.h5',
 'To_Study_Transformations'  : '/media/amr/Amr_4TB/Work/October_Acquistion/Diffusion_Multishell_Kurtosis_workingdir/Multishell_workflow_Kurtosis/_subject_id_{subject_id}/FA_To_Study_Template/transformComposite.h5',
...
def CHARMED(dwi, mask):
		...
		return CHARMED_FA, CHARMED_MD, CHARMED_AD, CHARMED_RD, CHARMED_FR  



CHARMED = Node(name = 'CHARMED_r2',
                  interface = Function(input_names = ['dwi','mask'],
                  					   output_names = ['CHARMED_FA', 'CHARMED_MD', 'CHARMED_AD', 'CHARMED_RD', 'CHARMED_FR'],
                  function = CHARMED))
...
Multishell_CHARMED_workflow.run('MultiProc', plugin_args={'n_procs': 4})
